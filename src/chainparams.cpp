...
public:
    CMainParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 30; // Novatech: 1 day
        ...
        nZerocoinStartTime = 1531801217; // October 17, 2017 4:30:00 AM
        ...
        vSeeds.push_back(CDNSSeedData("51.38.191.44", "51.38.191.44"));         // Single node address
        vSeeds.push_back(CDNSSeedData("51.75.17.63", "51.75.17.63"));           // Single node address
        vSeeds.push_back(CDNSSeedData("37.59.108.203", "37.59.108.203"));       // Single node address
        ...
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x02)(0x2D)(0x25)(0x70).convert_to_container<std::vector<unsigned char> >();
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x02)(0x21)(0x31)(0x2B).convert_to_container<std::vector<unsigned char> >();
        // 	BIP44 coin type is from https://github.com/satoshilabs/slips/blob/master/slip-0044.md
        base58Prefixes[EXT_COIN_TYPE] = boost::assign::list_of(0x80)(0x00)(0x03)(0x3f).convert_to_container<std::vector<unsigned char> >();
        ...
        nPoolMaxTransactions = 3;
         strSporkKey = "0484698d2ba6ba6e7423fa5cbd5a89e0a9a5348f44d332b44a5cb1a8b7ed2c1eaa115fc8dc4f012cb8241cc0bdafd6ca70c5f5448916e4e2f511bcd746ed57dc50";
